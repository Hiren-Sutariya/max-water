...
export const Preloader: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Centered Prominent Splash Logo */}
      <div className="relative z-10 animate-[splashScale_0.6s_ease-out] drop-shadow-[0_0_50px_rgba(25,184,200,0.5)] scale-110 sm:scale-125">
